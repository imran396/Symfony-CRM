 ...
 */
class City extends \Beon\IntranetBundle\Entity\City implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Beon\\IntranetBundle\\Entity\\City' . "\0" . 'id', '' . "\0" . 'Beon\\IntranetBundle\\Entity\\City' . "\0" . 'name', '' . "\0" . 'Beon\\IntranetBundle\\Entity\\City' . "\0" . 'population', '' . "\0" . 'Beon\\IntranetBundle\\Entity\\City' . "\0" . 'notes', '' . "\0" . 'Beon\\IntranetBundle\\Entity\\City' . "\0" . 'events', '' . "\0" . 'Beon\\IntranetBundle\\Entity\\City' . "\0" . 'customer', '' . "\0" . 'Beon\\IntranetBundle\\Entity\\City' . "\0" . 'suppliers', '' . "\0" . 'Beon\\IntranetBundle\\Entity\\City' . "\0" . 'customers', 'contacts');
        }
