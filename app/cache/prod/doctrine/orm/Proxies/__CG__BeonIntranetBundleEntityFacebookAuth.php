 ...
 */
class FacebookAuth extends \Beon\IntranetBundle\Entity\FacebookAuth implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Beon\\IntranetBundle\\Entity\\FacebookAuth' . "\0" . 'id', '' . "\0" . 'Beon\\IntranetBundle\\Entity\\FacebookAuth' . "\0" . 'authToken', '' . "\0" . 'Beon\\IntranetBundle\\Entity\\FacebookAuth' . "\0" . 'expiresAt', '' . "\0" . 'Beon\\IntranetBundle\\Entity\\FacebookAuth' . "\0" . 'createdAt');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FacebookAuth $proxy) {
