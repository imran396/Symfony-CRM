...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'assetic.ruby.bin' => '/home/imran/.rvm/rubies/ruby-1.9.3-p448/bin/ruby',
            'assetic.sass.bin' => '/home/imran/.rvm/gems/ruby-1.9.3-p448/bin/sass',
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_5f90bc6186c6c36f5cd64df85a5a6e822b842c493812c915eb45187a222fcf1c');
        return $instance;
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $la = new \Symfony\Component\HttpFoundation\RequestMatcher('^/report/survey');
        $ma = new \Symfony\Component\HttpFoundation\RequestMatcher('^/report/timetrack');
        $na = new \Symfony\Component\HttpFoundation\RequestMatcher('^/report/facebook');
        $oa = new \Symfony\Component\HttpFoundation\RequestMatcher('^/report/campaignsaving');
        $pa = new \Symfony\Component\HttpFoundation\RequestMatcher('^/report/cpspm');
        $qa = new \Symfony\Component\HttpFoundation\RequestMatcher('^/report');
        $ra = new \Symfony\Component\HttpFoundation\RequestMatcher('^/upload.*(new|create)$');
        $sa = new \Symfony\Component\HttpFoundation\RequestMatcher('^/upload/?$');
        $ta = new \Symfony\Component\Security\Http\AccessMap();
        $ta->add($g, array(0 => 'ROLE_USERS'), NULL);
        $ta->add($h, array(0 => 'ROLE_USERS'), NULL);
        $ta->add($i, array(0 => 'ROLE_FACEBOOKURLS'), NULL);
        $ta->add($j, array(0 => 'ROLE_STAKEHOLDERS_ALL'), NULL);
        $ta->add($k, array(0 => 'ROLE_MONITOREDURLS'), NULL);
        $ta->add($l, array(0 => 'ROLE_SURVEYRESULTS'), NULL);
        $ta->add($m, array(0 => 'ROLE_CONTACTS'), NULL);
        $ta->add($n, array(0 => 'ROLE_CITIES'), NULL);
        $ta->add($o, array(0 => 'ROLE_TIMETRACKINGS'), NULL);
        $ta->add($p, array(0 => 'ROLE_SUPPLIERS'), NULL);
        $ta->add($q, array(0 => 'ROLE_CAMPAIGNS_ALL'), NULL);
        $ta->add($r, array(0 => 'ROLE_CAMPAIGNS_APPROVE'), NULL);
        $ta->add($s, array(0 => 'ROLE_CAMPAIGNS'), NULL);
        $ta->add($t, array(0 => 'ROLE_PRESSRELEASES_ALL'), NULL);
        $ta->add($u, array(0 => 'ROLE_PRESSRELEASES_APPROVE'), NULL);
        $ta->add($v, array(0 => 'ROLE_PRESSRELEASES'), NULL);
        $ta->add($w, array(0 => 'ROLE_NOTES_ALL'), NULL);
        $ta->add($x, array(0 => 'ROLE_NOTES_NEW'), NULL);
        $ta->add($y, array(0 => 'ROLE_NOTES_ALL'), NULL);
        $ta->add($z, array(0 => 'ROLE_TASKS_NEW'), NULL);
        $ta->add($aa, array(0 => 'ROLE_TASKS_EDIT'), NULL);
        $ta->add($ba, array(0 => 'ROLE_TASKS_NOTIFY'), NULL);
        $ta->add($ca, array(0 => 'ROLE_TASKS_APPROVE'), NULL);
        $ta->add($da, array(0 => 'ROLE_TASKS'), NULL);
        $ta->add($ea, array(0 => 'ROLE_COMPLAINTS_ALL'), NULL);
        $ta->add($fa, array(0 => 'ROLE_COMPLAINTS'), NULL);
        $ta->add($ga, array(0 => 'ROLE_STAKEHOLDERS_ADDRESS'), NULL);
        $ta->add($ha, array(0 => 'ROLE_STAKEHOLDERS_VIEW'), NULL);
        $ta->add($ia, array(0 => 'ROLE_STAKEHOLDERS_EDIT'), NULL);
        $ta->add($ja, array(0 => 'ROLE_STAKEHOLDERS_LIST'), NULL);
        $ta->add($ka, array(0 => 'ROLE_STAKEHOLDERS_ALL'), NULL);
        $ta->add($la, array(0 => 'ROLE_REPORTS_SURVEY'), NULL);
        $ta->add($ma, array(0 => 'ROLE_REPORTS_TIMETRACKING'), NULL);
        $ta->add($na, array(0 => 'ROLE_REPORTS_FACEBOOK'), NULL);
        $ta->add($oa, array(0 => 'ROLE_REPORTS_CAMPAIGNSAVINGS'), NULL);
        $ta->add($pa, array(0 => 'ROLE_REPORTS_CPSPM'), NULL);
        $ta->add($qa, array(0 => 'ROLE_REPORTS'), NULL);
        $ta->add($ra, array(0 => 'ROLE_UPLOADS_NEW'), NULL);
        $ta->add($sa, array(0 => 'ROLE_UPLOADS_LIST_ALL'), NULL);
        $ua = new \Symfony\Component\Security\Http\HttpUtils($d, $d);
        $va = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $ua, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($ua, '/login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'logout'));
        $va->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());
        $wa = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($ua, array());
        $wa->setOptions(array('login_path' => 'login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $wa->setProviderKey('secured_area');
        $xa = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $ua, array(), $a);
        $xa->setOptions(array('login_path' => 'login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($ta, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.administrators')), 'secured_area', $a, $c), 2 => $va, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $ua, 'secured_area', $wa, $xa, array('check_path' => 'login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $ta, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $ua, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $ua, 'login', false), NULL, NULL, $a));
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Beon\IntranetBundle\Lib\FallbackTranslator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => (__DIR__.'/translations'), 'debug' => false));
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'IntranetBundle:Form:_campaign_adsizeHeight_row.html.twig'), 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'IntranetBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_TASKS_ALL' => array(0 => 'ROLE_TASKS', 1 => 'ROLE_TASKS_EDIT', 2 => 'ROLE_TASKS_NEW', 3 => 'ROLE_TASKS_NOTIFY', 4 => 'ROLE_NOTES_NEW', 5 => 'ROLE_STAKEHOLDERS_ADDRESS'), 'ROLE_TASKS_CUSTOMER' => array(0 => 'ROLE_TASKS', 1 => 'ROLE_TASKS_NEW', 2 => 'ROLE_TASKS_NOTIFY', 3 => 'ROLE_NOTES_NEW'), 'ROLE_TASKS_OWNGROUP' => array(0 => 'ROLE_TASKS', 1 => 'ROLE_TASKS_NEW', 2 => 'ROLE_TASKS_EDIT', 3 => 'ROLE_NOTES_NEW', 4 => 'ROLE_STAKEHOLDERS_ADDRESS'), 'ROLE_TASKS_OWN' => array(0 => 'ROLE_TASKS', 1 => 'ROLE_NOTES_NEW'), 'ROLE_PRESSRELEASES_ALL' => array(0 => 'ROLE_PRESSRELEASES'), 'ROLE_PRESSRELEASES_CUSTOMER' => array(0 => 'ROLE_PRESSRELEASES'), 'ROLE_CAMPAIGNS_ALL' => array(0 => 'ROLE_CAMPAIGNS'), 'ROLE_CAMPAIGNS_CUSTOMER' => array(0 => 'ROLE_CAMPAIGNS'), 'ROLE_NOTES_ALL' => array(0 => 'ROLE_NOTES', 1 => 'ROLE_NOTES_NEW'), 'ROLE_NOTES_RELATED' => array(0 => 'ROLE_NOTES', 1 => 'ROLE_NOTES_NEW'), 'ROLE_STAKEHOLDERS_ALL' => array(0 => 'ROLE_STAKEHOLDERS_VIEW', 1 => 'ROLE_STAKEHOLDERS_EDIT', 2 => 'ROLE_STAKEHOLDERS_LIST'), 'ROLE_STAKEHOLDERS_CUSTOMER' => array(0 => 'ROLE_STAKEHOLDERS_VIEW', 1 => 'ROLE_STAKEHOLDERS_EDIT'), 'ROLE_STAKEHOLDERS_VIEW' => array(0 => 'ROLE_STAKEHOLDERS'), 'ROLE_TIMETRACKINGS_ALL' => array(0 => 'ROLE_TIMETRACKINGS'), 'ROLE_TIMETRACKINGS_OWN' => array(0 => 'ROLE_TIMETRACKINGS'), 'ROLE_TIMETRACKINGS_OWNGROUP' => array(0 => 'ROLE_TIMETRACKINGS'), 'ROLE_REPORTS_SURVEY' => array(0 => 'ROLE_REPORTS'), 'ROLE_REPORTS_TIMETRACKING' => array(0 => 'ROLE_REPORTS'), 'ROLE_REPORTS_FACEBOOK' => array(0 => 'ROLE_REPORTS'), 'ROLE_REPORTS_CAMPAIGNSAVINGS' => array(0 => 'ROLE_REPORTS'), 'ROLE_REPORTS_CPSPM' => array(0 => 'ROLE_REPORTS'), 'ROLE_COMPLAINTS_ALL' => array(0 => 'ROLE_COMPLAINTS', 1 => 'ROLE_NOTES_NEW'), 'ROLE_COMPLAINTS_CUSTOMER' => array(0 => 'ROLE_COMPLAINTS', 1 => 'ROLE_NOTES_NEW'), 'ROLE_SUPPLIERS' => array(0 => 'ROLE_CONTACTS'), 'ROLE_CITIES' => array(0 => 'ROLE_CONTACTS'), 'ROLE_CONFIG_TASKS' => array(0 => 'ROLE_CONFIG')));
    }
